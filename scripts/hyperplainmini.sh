...
#SBATCH --gpus=1
#SBATCH -t 0-02:00:00 # Time (D-HH:MM:SS)
...
pixi run -e gpu python src/hypertune1D/train_baseline.py --temp=10 --batch_size=500 --steps=20000  --num_trials=2 --num_train_samples=19000 --num_test_samples=1900 --num_val_samples=1000 --check_overfit_every=2850 --lattice_size=32 --out="/n/holystore01/LABS/iaifi_lab/Users/oalao/runstuff" --dir_model_weights="/scratch"