...
pixi run -e gpu python src/hypertune1D/baseline.py --temp=100 --batch_size=50 --steps=100  --num_trials=2 --num_train_samples=100 --num_test_samples=100 --num_val_samples=100 --lattice_size=32 --out="/home/orealao/orcd/pool/runstuff" --dir_model_weights="/home/orealao/orcd/scratch"