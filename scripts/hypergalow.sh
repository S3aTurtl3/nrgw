...
pixi run -e gpu python src/hypertune1D/scriptt.py --batch_size=500 --steps=20000 --temp=0.1 --num_trials=20 --num_train_samples=19000 --num_test_samples=1900 --num_val_samples=1900 --lattice_size=32 --out="/home/orealao/orcd/pool/runstuff" --dir_model_weights="/home/orealao/orcd/scratch"